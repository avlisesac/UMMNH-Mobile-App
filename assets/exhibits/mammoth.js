...
`,
  tlas: [
    ...
    },
    {
      ...
      a: `If you inspect the left side of the skull, you should be able to see a spot where this mammoth took heavy damage from another mammoth’s tusk. It has healed, however, and looks like a raised bone ‘patch’.`
    },
    {
  ...
  gallery: [
    {
      imageFile: require('../images/gallery/mammoth/Mammoth_01.jpg'),
      imageDescription: `Securing and inspecting the apparatus that holds the mammoth skull.`,
    },
    {
      imageFile: require('../images/gallery/mammoth/Mammoth_02.jpg'),
      imageDescription: `A close-up of how the skull is held aloft in the display.`,
    },
    {
      imageFile: require('../images/gallery/mammoth/Mammoth_03.jpg'),
      imageDescription: `Attaching the first of two cast reconstructed tusks to the mammoth skull.`,
    },
    {
      imageFile: require('../images/gallery/mammoth/Mammoth_04.jpg'),
      imageDescription: `Installing the skull into its new home in the People and the Planet gallery.`,
    },
  ],
}
