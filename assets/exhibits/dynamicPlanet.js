...
`,
  tlas: [
    {
      q: `Find the two pieces of wood. Lift them. Which one is heavier? Why do you think that is?`,
      a: `The piece of wood on the left is heavier. This is petrified wood, and it is heavier because all of the wood has been replaced by mineral!`
    },
    {
      q: `What is the difference between ‘weather’ and ‘climate’?`,
      a: `While weather describes the ever changing, short-term state of the atmosphere (It’s raining today! I hope it cools down tonight), climate refers to the overall state of an area (The desert is hot and dry, while the tundra is bitterly cold).`
    },
    {
      q: `Why might the Bobolink, pigeons, and some other birds grow magnetite crystals in their body?`,
      a: `The tiny piece of magnetite that they grow will interact with Earth's magnetic field, aiding in navigation.`
    }
  ],

  gallery: [
    {
      imageFile: require('../images/gallery/dynamicplanet/DynamicPlanet_01.jpg'),
      imageDescription: `Installing minerals into the Dynamic Planet exhibit.`,
    },
    {
      imageFile: require('../images/gallery/dynamicplanet/DynamicPlanet_02.jpg'),
      imageDescription: `The drawers throughout Dynamic Planet hold even more to see!`,
    },
    {
      imageFile: require('../images/gallery/dynamicplanet/DynamicPlanet_03.jpg'),
      imageDescription: `Two pieces of wood, one modern and one petrified. Interact with these to learn more about petrification!`,
    },
  ],
  whileYoureHere: [
    {
      title: `Mineral Drawers`,
      description: `Be sure to check out the pull-out drawers throughout the Dynamic Planet exhibit. There are tons of extra specimens to see!`
    },
  ],
}
